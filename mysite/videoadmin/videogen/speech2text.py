...
from videoadmin.videogen.conf import * #contains username and password to access Watson API
...
def run(speaker, video_file, workspace_path) :
	...
	file_ext = os.path.splitext(video_file)[1][1:]
	audio_init = AudioSegment.from_file(video_file, file_ext) #assuming input files are all supported by ffmpeg
